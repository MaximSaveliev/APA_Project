...
class Ui_Window_4(object):
    def setupUi(self, Window_4):
        ...
        Window_4.resize(800, 600)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        Window_4.setWindowIcon(icon)
        Window_4.setStyleSheet("background-color: rgb(245, 248, 250);\n"
"color: rgb(20, 23, 26);")
        self.backButton = QtWidgets.QPushButton(Window_4)
...
"}")
        ...
        self.downloadButton = QtWidgets.QPushButton(Window_4)
...
"}")
        ...
        self.uploadButton = QtWidgets.QPushButton(Window_4)
...
"}")
        ...
        self.realTimeButton = QtWidgets.QPushButton(Window_4)
...
"}")
    ...
    def retranslateUi(self, Window_4):
        ...
        Window_4.setWindowTitle(_translate("Window_4", "Color Detection"))
        self.backButton.setToolTip(_translate("Window_4", "Go Back"))
        self.downloadButton.setText(_translate("Window_4", " Download"))
        self.uploadButton.setText(_translate("Window_4", " Upload File"))
        self.realTimeButton.setText(_translate("Window_4", " Real Time"))
